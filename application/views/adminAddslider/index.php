    ...
    <div class="tab-content">    
        <div role="tabpanel" class="tab-pane active" id="tab-1">
            <fieldset class="scheduler-border">    
                <br>
                <form method="post" action="AdminAddSlider/insertWeb" enctype="multipart/form-data">
                    <div class="form-group">
                        <div class="col-md-offset-4">
                            <label class="control-label col-md-1">Date: </label>
                            <div class="col-md-offset-1 col-md-4">
                                <input type="text" class="form-control form-control" autocomplete="off" id="Date" name="txtDate" value="<?php echo $date = date('Y-m-d'); ?>" required />
                    ...
                    <div class="form-group col-md-offset-4">
                        ...
                        <div class="col-md-4">
                            <input type="file" id="fileImageName" class="form-control" name="fileImageName" />
                        </div>
                        <div class="clearfix"></div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">   
                        <div class="btn-group" role="group">
                            <button class="btn btn-primary" type="button" onClick="location.href = '/AdminAddSlider/reportClassList'">
                                <i class="fa fa-print "  aria-hidden="true"></i>  
                            </button>
                            <button class="btn btn-default  btn btn-primary" type="button" onClick="location.href = '/AdminAddSlider/excel'">
                        ...
                        <tbody>   
                            <?php foreach ($getalldataSlider as $row): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo '<img src="' . $row['imagePath'] . '"  class="img-responsive img-thumbnail col-md-6"  style="height:60px;width:100px;"/>'; ?>
                                    </td>
                ...
                <script type="text/javascript">
                    $(document).ready(function () {
                         ...
                         $('.fa-save').click(function () {
                                ...
                                var note = $(this).closest('tr').children('td:eq(3)').text();
                                $.ajax({
                                    type: 'POST',   
                                    url: 'AdminAddSlider/updateWeb',
                                    data: {'id': id, 'date': date, 'note': note},  
